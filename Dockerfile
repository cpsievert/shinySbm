...
RUN R -e 'install.packages(c("config","data.table","dplyr","quarto","DT","fresh","ggplot2","golem","igraph","magrittr","purrr","reshape2","sbm","shiny","shinyalert","shinydashboard","stringr","visNetwork","remotes"))'
