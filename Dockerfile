...
RUN R -e 'install.packages(c("colourpicker","config","data.table","dplyr","DT","flextable","fresh","ggplot2","golem","magrittr","patchwork","purrr","rmarkdown","sbm","shiny","shinyalert","shinydashboard","stringr","visNetwork","parallel"))'
