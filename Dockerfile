...
RUN R -e 'install.packages(c("config","data.table","knitr","dplyr","rmarkdown","DT","fresh","ggplot2","golem","magrittr","purrr","reshape2","sbm","shiny","shinyalert","shinydashboard","stringr","visNetwork","remotes","flextable","patchwork"))'
