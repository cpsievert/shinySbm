...
```
<br>
Ici par exemple `r round_prop(R$sbm$blockProp$row)[[R$sbm$nbBlocks[[1]]]]*100`\% des `r R$upload$labels$row` sont dans le groupe `r col_group_names[[R$sbm$nbBlocks[[1]]]]`. 
...
exemple_val <- round(R$sbm$connectParam$mean[1,2],nb_digits)
if(R$sbm$modelName == "bernoulli"){
  connect_paraph <- paste0("Par exemple, si l'on prend un noeud A dans le groupe ",
         ...
         col_group_names[[2]]," en colonnes. Alors le noeud A ","\ue0",
         " une probabilit","\ue9"," ",exemple_val," d'",
  ...
  connect_paraph <- paste0("Par exemple, les noeuds du groupe ",
         ...
         col_group_names[[2]]," en colonnes ont une connection valant en moyenne ",
         exemple_val," . On peut simuler leur connection par une loi de ",
         modelName," de param","\ue8","tre lamba = ",exemple_val," .")
}else{
  connect_paraph <- paste0("Par exemple, les noeuds du groupe ",
         row_group_names[[1]]," en lignes et les noeuds du groupe ",
         col_group_names[[2]]," en colonnes ont une connection valant en moyenne ",
