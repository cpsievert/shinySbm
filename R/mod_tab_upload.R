...
mod_tab_upload_ui <- function(id){
  ...
  tagList(
    fluidRow(
      shinydashboard::box(title = "Data Selector", solidHeader = T,
      ...
      conditionalPanel(
        condition = "input.whichData == 'importData'",
        shinydashboard::box(title = "Reading Parameters", solidHeader = T,
      ...
      shinydashboard::box(title = "Network Setup", solidHeader = T,
